...
LLVMValueRef ll_regfile_get(LLRegisterFile*, RegisterFacet, Reg, LLState*);
void ll_regfile_clear(LLRegisterFile*, Reg, LLState*);
void ll_regfile_zero(LLRegisterFile*, Reg, LLState*);
void ll_regfile_rename(LLRegisterFile*, Reg, Reg, LLState*);
void ll_regfile_set(LLRegisterFile*, RegisterFacet, Reg, LLVMValueRef, bool, LLState*);
